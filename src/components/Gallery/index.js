...
class Gallery extends Component {
  ...
  getFilteredThumbnails = () => {
    ...
    const filteredThumbnails = imagesList.filter(
      eachThumbnail => eachThumbnail.id === activeThumbnailId,
    )
      ...
      <div className="app-container">
        <div className="container">
          {filteredThumbnails.map(item => (
            <li key={item.id} className="list-items-container">
              <img
                src={item.imageUrl}
          ...
          <ul className="thumbnail-container">
            {imagesList.map(thumbDetails => (
              <ThumbnailItem
                key={thumbDetails.id}
                thumbDetails={thumbDetails}
                clickThumbItem={this.clickThumbItem}
                isActive={activeThumbnailId === thumbDetails.id}
              />
            ))}
          </ul>
        </div>
